...
$stmt = $pdo->query("SELECT * FROM about_us WHERE is_active = 1 and category = 'training' ORDER BY sort_order ASC, id ASC");
...
<div class="main-content">
    <div class="container about-page-wrapper">
        <div class="about-card">
            <div class="about-header">Training & Discipline</div>
