...
$stmt = $pdo->prepare("SELECT * FROM about_us WHERE category = 'sponsorships' AND is_active = 1 ORDER BY sort_order ASC, id ASC");
$stmt->execute();
...
<div class="main-content">
    <div class="container about-page-wrapper">
        <div class="about-card">
            <div class="about-header">League Sponsorships</div>
